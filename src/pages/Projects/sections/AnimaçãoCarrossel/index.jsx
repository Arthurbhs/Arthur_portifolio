...
const Carousel = () => {
  ...
  const slides = [
    { id: 1, videoSrc: Video, alt: "animações de ação", type: "video" },
    { id: 2, videoSrc: Video1, alt: "animação para web serie e documentario", type: "video" },
    { id: 3, videoSrc: Video2, alt: "animações engraçadas", type: "video" },
  ];
